...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        {
            var emailClaim = HttpContext.User.Claims.Where(claim => claim.Type == "email").FirstOrDefault(); //Esto de los claims solo va a funcionar si se usa Authorize como Data Anotation
        ...
        [HttpPut("{id:int}", Name = "actualizarComentario")] //api/autores/1 (o 2 o 3 o lo que sea)
        public async Task<ActionResult> Put(int libroId, int id, ComentarioCreacionDTO comentarioCreacionDTO)
        {
            ...
            context.Update(comentario); //Marcando el comentario que vamos a actualizar
